...
import { AlertTriangle, Bone, ClipboardList, ShieldAlert } from "lucide-react";
...
export function AlgorithmIncompleteHint() {
  return (
    <div className="flex items-start gap-2 text-sm text-amber-700 dark:text-amber-300">
      <AlertTriangle className="h-4 w-4 shrink-0" />
      <span>Complete the assessment before treating unknown values as negative.</span>
    </div>
  );
}
