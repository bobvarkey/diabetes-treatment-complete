...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Source+Sans+3:wght@400;500;600;700&family=Playfair+Display:ital,wght@0,500;0,600;0,700&family=JetBrains+Mono:wght@400;500&display=swap",
      },
    ],
    scripts: [
      { children: themeBootScript },
      ...(import.meta.env.DEV ? [{ src: "/mock/appbuild-wrapper-sdk.mock.js" }] : []),
    ],
  }),
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="en" className="overflow-x-clip max-w-full">
      ...
      <body className="max-w-full overflow-x-clip">{children}<Scripts /></body>
    </html>
  );
}
